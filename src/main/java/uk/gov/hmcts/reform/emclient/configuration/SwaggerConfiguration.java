...
public class SwaggerConfiguration implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Financial Remedy Evidence Management Client ")
                .description("This service will serve as evidence management client for the financial remedy")
                .build();
    }

    // The following overrides will be removed with spring 2.0.8 update
